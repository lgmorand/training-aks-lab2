...
In order to move forward, you need to import the source code in your Azure DevOps project. This repository will be used for the different parts of this workshop.
...
We could build the app and then containerize the result, but it also smart to do the build within a container and guaranty the same behavior of the build part too.
{% collapsible %}
